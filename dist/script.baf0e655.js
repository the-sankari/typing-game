...
var RANDOM_QUOTE_API_URL = 'http://api.quotable.io/random';
...
function getRandomQuote() {
  return fetch(RANDOM_QUOTE_API_URL).then(function (response) {
...
function renderNewQuote() {
  return _renderNewQuote.apply(this, arguments);
}

function _renderNewQuote() {
  _renderNewQuote = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var quote;
